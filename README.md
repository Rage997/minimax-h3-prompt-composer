...
1. Download **[H3_Prompt_Composer_V5_38_2.html](H3_Prompt_Composer_V5_38_2.html)**.
...
V5.38.2 carries forward the V5.37.1 workflow and documentation with refined camera planning, camera-language consistency, and project migration.
...
- **[SHA-256 checksum](H3_Prompt_Composer_V5_38_2_SHA256.txt)** — verifies the standalone HTML file.
